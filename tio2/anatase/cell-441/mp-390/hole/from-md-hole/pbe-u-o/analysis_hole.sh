...
directories=("pbe" "u-2.0" "u-2.5" "u-3.0" "u-3.5" "u-4.0" "u-4.5" "u-5.0" "u-5.5" "u-6.0" "u-6.5" "u-7.0" "u-7.5" "u-8.0" "u-8.5" "u-9.0")
directories=("pbe" "u-2.0" "u-2.1" "u-2.2" "u-2.3" "u-2.4" "u-2.5" "u-2.6" "u-2.7" "u-2.8" "u-2.9" "u-3.0" "u-3.5" "u-4.0" "u-4.5" "u-5.0" "u-5.5" "u-6.0" "u-6.5" "u-7.0" "u-7.5" "u-8.0" "u-8.5" "u-9.0")
...
for dir in "${directories[@]}"; do
    ...
    homo_energy_beta_last=$(awk '/Fermi Energy/ {print prev} {prev=$0}' $log_file | awk '{print $3}' | tail -n 1)
    homo_energy_alpha_first=$(awk '/Fermi Energy/ {print prev} {prev=$0}' $log_file | awk '{print $4}'  | head -n 1)
    homo_energy_beta_first=$(awk '/Fermi Energy/ {print prev} {prev=$0}' $log_file | awk '{print $3}' | head -n 2 | tail -n 1)
